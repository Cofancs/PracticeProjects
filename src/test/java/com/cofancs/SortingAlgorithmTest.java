...
public class SortingAlgorithmTest {
    ...
    public void sortNullsToTheEndShouldReturnCorrectOrder(){
        ...
        Object[] result=underTest.checkInputThenSortEmptyToTheEnd(inputArray);
    ...
    public void sortNullsToTheEndThrowsExceptionForEmptyArray(){
        Object[] inputArray= {};
        assertThrows(IllegalArgumentException.class,()->{underTest.checkInputThenSortEmptyToTheEnd(inputArray);},SortingAlgorithm.INPUT_ARRAY_SHOULDN_T_BE_NULL);
    }
    @Test
    @DisplayName("╯°□°）╯'abc'")
    public void sortNullsToTheEndThrowsExceptionForNotCorrectInputABC(){
        Object[] inputArray= {"-",'-',4,"bf"};
        assertThrows(IllegalArgumentException.class,()->{underTest.checkInputThenSortEmptyToTheEnd(inputArray);},SortingAlgorithm.INPUT_CAN_CONTAINS_DIGITS_AND_A_SINGLE_CHARACTERS);
    }
