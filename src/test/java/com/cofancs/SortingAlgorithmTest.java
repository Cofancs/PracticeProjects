...
public class SortingAlgorithmTest {
    ...
    public void sortNullsToTheEndThrowsExceptionForEmptyArray() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            underTest.checkInputThenSortEmptyToTheEnd(inputArray);
        }, SortingAlgorithm.INPUT_ARRAY_SHOULDN_T_BE_NULL);
    }
    ...
    public void sortNullsToTheEndThrowsExceptionForNotCorrectInputABC() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            underTest.checkInputThenSortEmptyToTheEnd(inputArray);
        }, SortingAlgorithm.INPUT_CAN_CONTAINS_DIGITS_AND_A_SINGLE_CHARACTERS);
    }
